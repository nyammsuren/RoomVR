...
export function createRoom3(scene, camera, renderer) {
    ...
    // ======================
    // БУЦАХ ХААЛГА → Угтах танхим (арын хана, x=-3)
    // ======================
    ...
    backDoor.position.set(-3, 1, RD/2 - 0.15);
    ...
    bdLbl.position.set(-3, 2.4, RD/2 - 0.05);
    bdLbl.rotation.y = Math.PI;
    room.add(bdLbl);
